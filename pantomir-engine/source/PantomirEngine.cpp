...
static const std::vector<const char*> m_vulkanValidationLayers = {"VK_LAYER_KHRONOS_validation"};
static std::vector<const char*>       m_vulkanDeviceExtensions = {VK_KHR_SWAPCHAIN_EXTENSION_NAME};
...
void PantomirEngine::init_sync_structures() {
...
void PantomirEngine::destroy_swapchain() {
